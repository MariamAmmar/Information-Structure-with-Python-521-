...
#Validate input or return error and ask for re-entry
    ...
    sad_options =     (1, "Listen to a Song"),     (2, "Write about it"),     (3, "Meditate"),     (4, "Read an inspirational quote"),     (5, "Get some tips"),    (6, "Read a funny poem")
    
    
    #If user inputs a score of 5 or above, these selections printed
    happy_options =     (1, "Listen to a Song"),     (2, "Write a letter to your future self"),     (3, "Take note of some great ideas"),     (4, "Plan your birthday celebration"),     (5, "Have a dance party"),    (6, "Read a fun fact")
    ...
    #If user input from 3-4, output messsage below with sad options
    if 2 < mood < 5:
        print(f'''
        Why so blue? 
...
Prepare a celebration or choose one of the options below.\n''')
    ...
    #Could have been also been defined as list of tuple. 
    ...
    quotes =     [    '''"To anyone out there who’s hurting — 
    ...
    fun_facts =     ("More people get attacked every year by a cow than by a shark.",
    ...
    #Plays meditation audio
        ...
        #Users inputs as arguments to generate madlib from User class
        while True:
            try:
                n1, n2 =                 input("Input two nouns with a space in between.").split()
                adj1, adj2, adj3                = input("Input three adjectives with a space in between.")                .split()
            except:
                print("Sorry try again.")
            else:
    ...
    #Next three options allow user to input entry into journal
        ...
        #Prints funny string character by character using time delay
        strng = "~~~~~~~~~!!!!! ♪┏(・o･)┛♪┗ ( ･o･) ┓♪~~~~~~!!!!~~~~~~"
        for i in strng:
            print(i, end = "")
            time.sleep(0.05)
    ...
    user_input =     input    ("\nPress 'b' to go back to the main menu or another character to exit the program.")
